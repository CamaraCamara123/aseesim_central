...
const navigation: NavigationItem[] = [
    ...
    { name: 'Evenement', href: '#cook-section', current: false },
    { name: 'Section', href: '#about-section', current: false },
                    ...
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex sm:hidden flex-shrink-0 items-center border-right">
                                <Image src="/images/Logo/aseesim.png" alt="logo" width={36} height={36} />
                            ...
                            <div className='gap-6 hidden lg:flex'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <p className='text-lg font-medium'><a href='mailto:aseesim.bureauCentral@gmail.com'>Email</a></p>
                                </div>
